  ...
  return (
    <section
      ...
      style={{
        background: `linear-gradient(
          to bottom,
          hsl(var(--brand-secondary) / 0.3) 0%,
          hsl(var(--brand-primary) / 0.4) 50%,
          hsl(var(--brand-forest) / 0.5) 100%
        )`,
      }}
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <h2 className="font-brand text-5xl md:text-6xl font-bold text-[hsl(var(--brand-cream))] mb-8">
              Our Ritual
            </h2>
            
            <p className="text-lg text-[hsl(var(--brand-cream) / 0.9)] font-body mb-8 leading-relaxed">
              Like patient birdwatchers waiting for that perfect moment of discovery, we craft our kombucha with time, attention, and endless curiosity.
            </p>
            
            <p className="text-lg text-[hsl(var(--brand-cream) / 0.9)] font-body mb-12 leading-relaxed">
              Our brewing process mirrors the gentle rhythms of nature — slow fermentation, organic ingredients, and the kind of care that comes from truly watching and waiting.
            </p>
              ...
              {ritualSteps.map((step, index) => (
                ...
                >
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-[hsl(var(--brand-forest))]"
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[hsl(var(--brand-cream))] mb-2">
                      {step.title}
                    </h3>
                    <p className="text-[hsl(var(--brand-cream) / 0.8)] leading-relaxed">
                      {step.description}
                    </p>
                  </div>
                </div>
          ...
          <div className={`relative transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative">
              ...
              <div className="absolute bottom-8 left-8 text-center">
                <div className="text-6xl font-light text-[hsl(var(--brand-cream))] mb-2">7</div>
                <div className="text-lg text-[hsl(var(--brand-cream) / 0.8)] font-medium">Days</div>
              </div>
            </div>
          </div>
        </div>
